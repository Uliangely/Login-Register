...
function Registro() {
  ...
  const header = (
    <div className="font-bold mb-3 bg-black text-white">Pick a password</div>
  );
  const footer = (
    <>
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    const res = await fetch("/api/auth/register", {
      ...
      body: JSON.stringify({
        ...
        segundo_apellido:
          data.lastname?.split(" ")[1] !== undefined
      ...
      <div className="flex flex-row">
        ...
        <div className="text-black bg-black h-auto w-140">
          <form
            ...
            className="p-[3rem] space-y-1 bg-black"
          >
              ...
              >
                <div className="flex flex-row space-x-4 pt-8 bg-black text-white">
                  <div className="mb-5 bg-black">
                    ...
                    />
                    {errors.name && (
                      <span className="text-red-600 flex mt-1">
                        {errors.name.message}
                      </span>
                    )}
                  </div>
                ...
                <div className="flex flex-row space-x-4  ">
                  <div>
                    ...
                    >
                      ...
                      <option value="Venezuela" className=" bg-black">
                        Venezuela
                      </option>
                      <option value="Colombia" className=" bg-black">
                        Colombia
                      </option>
                      <option value="Alemania" className=" bg-black">
                        Alemania
                      </option>
                    </select>
                    {errors.nationality && (
